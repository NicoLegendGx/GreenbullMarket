...
const addToCart = () => {
    ...
    M.toast({
    html: `${pokemonData.name} añadido al carrito 🛒`,
...
return (
    ...
    <div className="container center" style={{ marginTop: "40px" }}>
        ...
        >
            ...
            <p>
            <b>Altura:</b> {pokemonData.height}
            </p>
            <p>
            <b>Peso:</b> {pokemonData.weight}
            </p>
            ...
            <b>Precio:</b> ${price}.000
            </p>

            <button
            className="btn waves-effect blue darken-2"
